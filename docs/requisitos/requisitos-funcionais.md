...
Este requisito refere-se a acidentes causados por equipamentos de segurança individual (EPI’s), ou seja, quando o estado do EPI não está nos conformes.

## RF03: O Sistema deve controlar o estoque dos EPI's;
...
## RF04: O Sistema deve controlar a manutenção dos EPI's;

Este requisito refere-se ao controle de seu estado de manutenção em relação à qualidade de proteção dos EPI’s que estão sendo utilizados e dos que estão armazenados no estoque.
...
## RF10: O sistema deve correlacionar automaticamente acidentes com as tarefas, áreas e equipamentos envolvidos; Anexar mídias e testemunhas
...
## RF12: O sistema deve controlar a rastreabilidade dos EPI’s (equipamentos de segurança individual);
...
## RF14: O sistema deve permitir a conexão entre as tarefas e os EPI’s.

Este requisito refere-se à interligação entre tarefas e seus devidos EPI’s, ou seja, os que devem ser utilizados durante sua execução.
...
## RF17: O sistema deve permitir a gestão de descarte dos EPI’s
...
## RF19: O sistema deve permitir o registro de incidentes (quase acidentes)
...
## RF23: O sistema deve permitir a gestão de fornecedores e C.A (certificado de aprovação)
