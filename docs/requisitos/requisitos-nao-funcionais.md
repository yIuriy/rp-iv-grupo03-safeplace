...
## RNF02 — Monitoramento em tempo real

O sistema deve processar e exibir dados de sensores ambientais com latência máxima de 500 milissegundos, garantindo respostas imediatas em situações de emergência.

## RNF03 — Capacidade de usuários simultâneos

O sistema deve suportar ao menos 200 usuários simultâneos sem degradação perceptível de desempenho, sendo escalável conforme o crescimento da organização.

## RNF04 — Controle de acesso por perfil

O sistema deve implementar controle de acesso baseado em perfis (RBAC), restringindo funcionalidades conforme o papel do usuário, sendo eles: operador, gestor de segurança e administrador.

## RNF05 — Criptografia de dados sensíveis
...
## RNF06 — Rastreabilidade de ações (auditoria)
...
## RNF09 — Funcionamento offline parcial

As funcionalidades críticas de registro de acidentes e incidentes devem operar em modo offline por meio de recursos de Progressive Web App (PWA), armazenando os dados localmente no dispositivo e sincronizando automaticamente com o servidor quando a conexão for restabelecida. Funcionalidades que dependem de processamento em tempo real, como monitoramento de sensores e dashboards, ficam indisponíveis durante a ausência de conexão.

## RNF10 — Conformidade com normas regulamentadoras
...
## RNF11 — Integridade e validade dos documentos gerados
...
## RNF12 — Interface responsiva e acessível
...
## RNF13 — Facilidade de aprendizado
...
## RNF15 — Modularidade e extensibilidade

O sistema deve ser desenvolvido em arquitetura modular, permitindo a adição de novos módulos, como novos tipos de sensores ou integração com sistemas ERP, sem impacto nas demais funcionalidades já existentes.

## RNF16 — Documentação técnica
...
## RNF17 — Compatibilidade com navegadores e sistemas operacionais
...
## RNF18 — Integração via API

O sistema deve expor uma API RESTful documentada no padrão OpenAPI 3.0 para integração com sistemas externos, como ERPs, sistemas de recursos humanos e plataformas de sensores IoT, utilizando autenticação OAuth 2.0.
