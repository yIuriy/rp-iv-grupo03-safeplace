...
public record EpiResponse(
        ...
        @Schema(description = "Quantidade em estoque atual", example = "25") int quantidade,

        @Schema(description = "Estoque mínimo configurado", example = "5") int estoqueMinimo,

        @Schema(description = "Indica se o estoque está crítico (saldo <= estoqueMinimo)", example = "false") boolean estoqueCritico,

        @Schema(description = "Status atual do EPI", example = "DISPONIVEL") StatusEpi status,

        @Schema(description = "Data de validade do CA", example = "2027-12-31") LocalDate dataValidadeCa,

        @Schema(description = "Vida útil estimada em dias", example = "365") Integer vidaUtilDias,
